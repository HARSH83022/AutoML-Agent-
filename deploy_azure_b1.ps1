# Azure Deployment Script for AutoML Platform (B1 Tier)

Write-Host "Deploying AutoML Platform to Azure (B1 tier)..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  SKU: B1 (Basic - ~`$13/month)"
Write-Host ""
...
Write-Host ""
Write-Host "Cost: ~`$13/month (B1 Basic tier)" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "  Stop (save $): az webapp stop --name $APP_NAME --resource-group $RESOURCE_GROUP"
